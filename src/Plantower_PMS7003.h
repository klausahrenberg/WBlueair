...
const unsigned char ACTIVE_MODE[]  = {0x42, 0x4D, 0xE1, 0x00, 0x01, 0x01, 0x71};
const unsigned char PASSIVE_MODE[] = {0x42, 0x4D, 0xE1, 0x00, 0x00, 0x01, 0x70};
const unsigned char PASSIVE_READ[] = {0x42, 0x4D, 0xE2, 0x00, 0x00, 0x01, 0x71};
